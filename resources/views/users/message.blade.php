...
@section('page_title', 'Auto Mechanics | Chats')
...
<section id="breadcrumbs" class="breadcrumbs "
    ...
    <div class="container position-relative ">
        ...
        <div class="justify-content-center position-absolute mt-5 border p-lg-3 p-y-3 shadow rounded w-50"
            ...
            <h2 class="fs-2 fw-bold text-white mt-4 text-center">Messenger</h2>
            <ol class=" justify-content-center mt-4">
                <li class=" fw-bold"><a href="../../index.html">Home</a></li>
                <li class=" text-white fw-bold">Messages</li>
            </ol>
        </div>
    </div>
                            ...
                            <div class="tab-pane fade show active " id="home" role="tabpanel"
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item position-relative">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <img src="{{$convo['receiver_data']['profile']}}"
                                                class="img-fluid rounded-circle me-2"
                                                style="width: 50px; object-fit: cover; height:50px">
                                            <a class="dropdown-item fw-bold  overflow-hidden" href="/{{$convo['receiver']}}">
                                                {{ $convo['receiver_data']['name']['first_name'] }} {{
                                                $convo['receiver_data']['name']['middle_name'] }} {{
                                                $convo['receiver_data']['name']['last_name'] }} {{
                                                $convo['receiver_data']['name']['suffix'] }}
                                                <br>
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="d-flex align-items-center justify-content-start my-2">
                            <!-- <button class="btn btn-light"><i class="bx bxs-smile fs-3 fw-bold "></i></button>
                            <button class="btn btn-light" id="uploadButton"><i
                                    class="bx bxs-image-alt fs-3 fw-bold"></i></button>
                            <input type="file" id="imageInput" style="display:none">
                            <button class="btn btn-light"><i class="bx bxs-camera fs-3 fw-bold "></i></button> -->
                        </div>
                    </div>
                </div>
            </div>
